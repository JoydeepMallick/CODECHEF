...
void test(){
    ...
    /*
      n = 1     no move for alice, Bob wins 
      n = 2     no move for alice, Bob wins 
      n = 3     no move for bob, Alice wins 
      n = 4     no move for alice, Bob wins 
      n = 5     no move for bob, Alice wins 
      n = 6     A - 3 ,  n = 2 no move for Bob, Alice wins  
      n = 7     Alice wins
      n = 8     Bob wins 
      n = 9     A -  3 , n = 6, B - 3 , n = 3   so Alice wins 
      n = 10    A - 5 , n = 5 B - 5 Bob wins  
     
     
Observe the given sample test cases carefully and dry run n = [0,10]. The coclusion is: if the n is even or without any prime factors(1) : Bob will win if the n is odd : Alice will win
     */

    if(n>1 && n&1) cout << "Alice\n";
    else cout << "Bob\n";
}
