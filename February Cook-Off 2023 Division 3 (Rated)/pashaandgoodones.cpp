...
void test(){
  ...
  cin >> n >> k;
     ...
     * assume 4 0 , abcd
     *
     * here when substring is ab or bc or cd then only freq(of any one element ) is 1 and 2*1 - 2 is 0 which is needed.
     *
     *
     * assume 4 -1   abac
     *
     * assume substring bac here freq of any element is 1. so 2*freq() - 3 = -1 
     *
     * hence answer should be 3 but 4 given
     *
     *
     * assume 3 1  aab
     *
     * assume entire string and a then 2*freq('a') - 3 = 1
     * hence  from here we get 1
     *
     * and for each element we also get 1 each
     * hence total 4.
     */
}
